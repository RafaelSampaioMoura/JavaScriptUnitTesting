...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(objetoRetornado1).toHaveProperty('fetchMenu');
    ...
    expect(objetoRetornado3.fetchMenu()).toEqual({
      food: { coxinha: 3.9, sopa: 9.9 },
      drink: { agua: 3.9, cerveja: 6.9 },
    });
    ...
    expect(objetoRetornado5.consumption).toEqual([
      'coxinha',
      'agua',
      'sopa',
      'sashimi',
    ...
    objetoRetornado6.order('coxinha');
    expect(objetoRetornado6.pay()).toBeCloseTo(12.87, 4);
